...
async def refresh_token(credentials: HTTPAuthorizationCredentials = Security(security), db: Session = Depends(get_db)):
    """AI is creating summary for refresh_token

    Args:
        credentials (HTTPAuthorizationCredentials, optional): [description]. Defaults to Security(security).
